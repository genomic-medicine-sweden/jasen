...
conda install -y -c bioconda bowtie2 cd-hit blast=2.9.0 bwa=0.7.17 fastqc mlst mummer kraken2 picard=2.20.3 pigz=2.4 quast=5.0.2 samtools=1.9=h8571acd_11 spades=3.13.1 trimmomatic=0.39
