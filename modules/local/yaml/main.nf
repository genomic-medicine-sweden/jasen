process create_yaml {
    ...
    def kleborate_arg               = kleborate_general         ?  "--kleborate ${params.outdir}/${params.species_dir}/kleborate/${kleborate}" : ""
    def kleborate_hamronization_arg = kleborate_hamronization   ?  "--kleborate-hamronization ${params.outdir}/${params.species_dir}/kleborate/${kleborate}" : ""
