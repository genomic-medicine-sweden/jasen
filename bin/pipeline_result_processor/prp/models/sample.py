...
from .typing import TypingMethod, TypingResultCgMlst, TypingResultMlst, TypingResultLineage, TypingResultSnp, TypingSoftware
...
class MethodIndex(RWModel):
    ...
    result: Union[ElementTypeResult, TypingResultMlst, TypingResultCgMlst, TypingResultLineage, TypingResultSnp]
