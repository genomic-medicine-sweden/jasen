...
from .models.typing import TypingResultMlst, TypingResultCgMlst
from .models.phenotype import PhenotypeResult, ResistanceGene, ResistanceVariant, VirulenceGene
...
def parse_cgmlst_results(file: str, include_novel_alleles: bool = True) -> TypingResultCgMlst:
...
def parse_resistance_pred(prediction: Dict[str, Any], resistance_category) -> Tuple[SoupVersions, PhenotypeResult]:
